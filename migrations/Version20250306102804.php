 ...
 */
final class Version20250306102804 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D6493E506FC8 FOREIGN KEY (walk_group_id) REFERENCES `group` (id)');
